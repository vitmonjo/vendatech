...
export const routes: Routes = [
  ...
  { path: 'my-products', component: MyProducts, canActivate: [adminGuard] },
  { path: 'my-products/new', component: ProductForm, canActivate: [adminGuard] },
  { path: 'my-products/edit/:id', component: ProductForm, canActivate: [adminGuard] },
